 ...
 * @see fr.formation.inti.dao.Users
...
public class UsersHome {
	...
	public Users findById(int id) {
		...
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get("fr.formation.inti.dao.Users", id);
			if (instance == null) {
	...
	public List<Users> findByExample(Users instance) {
		...
		try {
			List<Users> results = (List<Users>) sessionFactory.getCurrentSession()
					.createCriteria("fr.formation.inti.dao.Users").add(create(instance)).list();
