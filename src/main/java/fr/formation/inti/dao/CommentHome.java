 ...
 * @see fr.formation.inti.dao.Comment
...
public class CommentHome {
	...
	public Comment findById(Integer id) {
		...
		try {
			Comment instance = (Comment) sessionFactory.getCurrentSession().get("fr.formation.inti.dao.Comment", id);
			if (instance == null) {
	...
	public List<Comment> findByExample(Comment instance) {
		...
		try {
			List<Comment> results = (List<Comment>) sessionFactory.getCurrentSession()
					.createCriteria("fr.formation.inti.dao.Comment").add(create(instance)).list();
