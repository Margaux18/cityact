...
<link href="<c:url value="/resources/css/css_map.css" />"
	rel="stylesheet">
								...
								<div class="input-group input-group-btn mx-auto">
									...
									<form class="form-inline col-sm-3">
										...
										<div class="dropdown-menu" aria-labelledby="btn_ajout">
											<button
												class="col-12 list-group-item btn btn-primary btn-block btn_of_btn_ajout">Signalements</button>
											<button
												class="col-12 list-group-item btn btn-primary btn-block btn_of_btn_ajout">Ambient
												Power</button>
											<button
												class="col-12 list-group-item btn btn-primary btn-block btn_of_btn_ajout">Propositions
												d'aménagements</button>
										</div>
									</form>
								</div>
							</div>
