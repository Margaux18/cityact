...
<!-- 							<form class="form-inline col-sm-2">
							...
							<form class="form-inline col-sm-8">
  									...
  									<div class="dropdown-menu" aria-labelledby="btn_category">
  										<div class="list-group">
  											<div class="dropdown_checkbox checkbox list-group-item col-12 py-1">
  													<div class="row"">
  														<input class="form-check-input col-2 my-auto" id="input_category_signalement"  type="checkbox" value="" id="defaultCheck1"> 
  														<label class="col-9 label_of_filterscheckbox" for="input_category_signalement">Signalements</label>
  													</div>
  													
  											</div>
  											<div class="dropdown_checkbox checkbox list-group-item col-12 py-1">
  													<div class="row">
  														<input class="form-check-input col-2 my-auto" id="input_category_ambientpower"  type="checkbox" value="" id="defaultCheck1"> 
  														<label class="col-9 label_of_filterscheckbox" for="input_category_ambientpower">Ambient Power</label>
  													</div>
  										...
  										<div class="list-group">
  											<div class="list-group-item">
  												...
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  														<input class="form-check-input col-2 my-auto" id="input_souscategory_moburbain" type="checkbox" value="" id="defaultCheck1">
  														<label class="col-9 label_of_filterscheckbox" for="input_souscategory_moburbain">Mobilier urbain</label>
  													</div>
  												</div>
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  														<input class="form-check-input col-2 my-auto" id="input_souscategory_voirie" type="checkbox" value="" id="defaultCheck1">
  														<label class="col-9 label_of_filterscheckbox" for="input_souscategory_voirie">Voirie</label>
  													</div>
  												</div>
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  												...
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  														<input class="form-check-input col-2 my-auto" id="input_souscategory_signautre" type="checkbox" value="" id="defaultCheck1">
  														<label class="col-9 label_of_filterscheckbox" for="input_souscategory_signautre">Signalements autres</label>
  													</div>
  												</div>	
  											</div>
  											...
  											<div class="list-group-item">
  												...
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  														...
  														<label class="col-9 label_of_filterscheckbox" for="input_souscategory_temporaire">Temporaire</label>
  													</div>
  												</div>
  												<div class="checkbox col-12 py-1">
  													<div class="row">
  														<input class="form-check-input col-2 my-auto" id="input_souscategory_permanent" type="checkbox" value="" id="defaultCheck1">
  														<label class="col-9 label_of_filterscheckbox" for="input_souscategory_permanent">Permanent</label>
  													</div>
  												</div>
  											</div>
  											
  											<div class="list-group-item">
  												<h3 class="list-group-item-heading col-12">Ambient Power</h3>
  												<div class="checkbox col-12 py-1">
  													<div class="row">
								...
								<div class="col-sm-4">
									<button type="submit" class="btn btn-primary btn-block" id="btn_filtre">Filtrez</button>
								</div>
								
							</form>
							
							<form class="form-inline col-sm-3">
  									<button class="btn btn-secondary dropdown-toggle btn-block btn_dropdown" type="button" id="btn_ajout" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  								 		 Ajoutez un marqueur !
  									</button>
...
/* 					 // Create the search box and link it to the UI element.
				...
				<div class="col-sm-4" id="div_all_marqueurs">
					<div class="row">
						<div class="list-group col-sm-12" id="div_all_marqueurs_overflowscroll">
							 <ul class="list-group">
